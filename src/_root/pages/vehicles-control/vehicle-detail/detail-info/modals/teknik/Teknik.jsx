          ...
          <div className="grid gap-1 border p-20 mt-10">
            ...
            <div className="col-span-3">
              <div className="flex flex-col gap-1">
                ...
                <NumberInput name="tsilindirHacmi" />
              </div>
            </div>
            <div className="col-span-3">
              <div className="flex flex-col gap-1">
                <label>{t("silindirSayisi")}</label>
                <NumberInput name="tsilindirSaysi" />
              </div>
            </div>
            <div className="col-span-3">
              <div className="flex flex-col gap-1">
                <label>{t("maxHiz")}</label>
                <NumberInput name="dtyMaxHiz" />
              </div>
            </div>
            <div className="col-span-3">
              <div className="flex flex-col gap-1">
                <label>{t("motorGucuBG")}</label>
                <NumberInput name="tmotorGucu" />
              </div>
            </div>
            <div className="col-span-3">
              <div className="flex flex-col gap-1">
                <label>{t("tork")}</label>
                <NumberInput name="ttork" />
              </div>
            </div>
            <div className="col-span-3">
              <div className="flex flex-col gap-1">
                <label>{t("hizlanma")}</label>
                <NumberInput name="dtyHizlanma" />
              </div>
            </div>
            <div className="col-span-3">
              <div className="flex flex-col gap-1">
          ...
          <div className="grid gap-1 border p-20 mt-10">
            ...
            <div className="col-span-2">
              <div className="flex flex-col gap-1">
                ...
                <NumberInput name="tbagajHacmi" />
              </div>
            </div>
            <div className="col-span-2">
              <div className="flex flex-col gap-1">
                <label>{t("aksMesafesi")}</label>
                <NumberInput name="dtyAksMesafesi" />
              </div>
            </div>
            <div className="col-span-2">
              <div className="flex flex-col gap-1">
                <label>{t("boy")}</label>
                <NumberInput name="tboy" />
              </div>
            </div>
            <div className="col-span-2">
              <div className="flex flex-col gap-1">
                <label>{t("genislik")}</label>
                <NumberInput name="tgenislik" />
              </div>
            </div>
            <div className="col-span-2">
              <div className="flex flex-col gap-1">
                <label>{t("yukseklik")}</label>
                <NumberInput name="tyukseklik" />
              </div>
            </div>
            <div className="col-span-2">
              <div className="flex flex-col gap-1">
