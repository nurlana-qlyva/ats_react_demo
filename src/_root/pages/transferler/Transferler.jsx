...
import { GetMaterialTransferReceiptListService } from "../../../api/services/transferler_services";
...
const Transferler = () => {
    ...
    useEffect(() => {
        setLoading(true);
        GetMaterialTransferReceiptListService(tableParams?.pagination.current, search).then((res) => {
    ...
    useEffect(() => {
        if (search.length >= 3) {
            GetMaterialTransferReceiptListService(tableParams?.pagination.current, search).then(
                (res) => {
                    setData(res?.data.materialList);
                    setTableParams({
                        ...tableParams,
