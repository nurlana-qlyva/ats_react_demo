...
const StyledClockCircleOutlined = styled(FallOutlined)`
...
function Component3(props) {
  ...
  const yilSecimiToplamMesafe = watch("yilSecimiToplamMesafe");

  useEffect(() => {
    const yilSecimiValue = watch("yilSecimiToplamMesafe");
    if (!yilSecimiValue) {
  ...
  useEffect(() => {
    if (isModalVisible === true) {
      setValue("yilSecimiToplamMesafe", null);
      // reset({
