...
const StyledClockCircleOutlined = styled(FormOutlined)`
...
function Component2(props) {
  ...
  const yilSecimiYakitTuketimi = watch("yilSecimiYakitTuketimi");

  useEffect(() => {
    const yilSecimiValue = watch("yilSecimiYakitTuketimi");
    if (!yilSecimiValue) {
  ...
  useEffect(() => {
    if (isModalVisible === true) {
      setValue("yilSecimiYakitTuketimi", null);
      // reset({
