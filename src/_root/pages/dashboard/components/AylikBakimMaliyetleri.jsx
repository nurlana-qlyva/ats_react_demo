...
function AylikBakimMaliyetleri(props = {}) {
  ...
  const fetchData = async () => {
    setIsLoading(true);
    try {
      const response = await http.get(`GetAylikBakimIsEmriMaliyet?ID=2&year=${baslamaTarihi}`);
          ...
          <div style={{ width: '100%', height: 'calc(100% - 5px)' }}>
            <ResponsiveContainer ref={ref1} width="100%" height="100%">
              ...
              >
                ...
                <Bar dataKey="AYLIK_BAKIM_ISEMRI_MALIYET" stackId="a" fill="#8884d8" hide={!visibleSeries.AYLIK_BAKIM_ISEMRI_MALIYET} name="İş Emri Maliyeti">
