        ...
        <TreeSelect
            ...
            onChange={e => {
                ...
                if (e === undefined) {
                    ...
                    if (!selectedOption) {
                        setValue('edit_lokasyon', "")
                    }
                } else {
                    const selectedOption = data.find(option => option.lokasyonId === e);

                    if (selectedOption) {
                        setValue('edit_lokasyon', selectedOption.lokasyonTanim)
                    }
                }
            }}
        />
...
MalzemeLokasyon.propTypes = {
    field: PropTypes.shape({
        onChange: PropTypes.func,
    })
}

export default MalzemeLokasyon
